...
int main()
{
    ...
    Linear* m = new Linear(0.1, 0.05);
    Controller* r = new Controller(0.5, 5.0, 35.0, 10.0);
    PID_System(25, r, m, 0);

    cout << "\n\nNon_Linear:\nE\t\tY\t\tU\n";
    cout << "------------------" << endl;

    Non_Linear* nl = new Non_Linear(0.1, 0.0001, 0.1, 0.0001);
    Controller* nlr = new Controller(0.5, 5.0, 35.0, 7.0);
